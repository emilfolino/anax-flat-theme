...
# LESS and CSS
LESS 		 	= modules.less style.less light.less color.less dark.less colorful.less special-typography.less fun.less
...
# target: upgrade-grid - Upgrade LESS module - Responsive menu
.PHONY: upgrade-grid
upgrade-grid:
	@$(call HELPTEXT,$@)
